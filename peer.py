...
class PeerServer(threading.Thread):
    ...
    def run(self):
        ...
        print(f"{Fore.RED}Peer server started...{Fore.RESET}")
...
class peerMain:
    ...
    def __init__(self,username=None):
        ...
        self.username = username
        self.registryName = input(f"{Fore.LIGHTMAGENTA_EX}Enter IP address of registry: {Fore.RESET} ")
        ...
        while choice != "3":
            ...
            if not self.isOnline:
                ...
                # and the password to login
                    ...
                    peerServerPort = int(input(f"{Fore.LIGHTYELLOW_EX}Enter a port number for peer server: {Fore.RESET}"))
    ...
    def login(self, username, password, peerServerPort):
        ...
        if response == "login-success":
            print(f"{Fore.LIGHTYELLOW_EX}Logged in successfully...{Fore.RESET}")
            return 1
        elif response == "login-account-not-exist":
            print(f"{Fore.LIGHTRED_EX}Account does not exist...{Fore.RESET}")
            return 0
        elif response == "login-online":
            print(f"{Fore.LIGHTGREEN_EX}Account is already online...{Fore.RESET}")
            return 2
        elif response == "login-wrong-password":
            print(f"{Fore.LIGHTRED_EX}Wrong password...{Fore.RESET}")
            return 3
