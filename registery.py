...
print(f"{Fore.GREEN} Registy started...{Fore.RESET}")
port = 1500
portUDP = 1200
...
print(f"{Fore.CYAN}Registry IP address: {Fore.RESET} " + f"{Fore.LIGHTYELLOW_EX}{host}{Fore.RESET}")
print(f"{Fore.CYAN}Registry port number: {Fore.RESET}" + f"{Fore.LIGHTYELLOW_EX}{str(port)}{Fore.RESET}")
...
while inputs:
    ...
    print(f"{Fore.BLUE}Listening for incoming connections... {Fore.RESET}")
        ...
        # if the message received comes to the udp socket
            ...
            if message[0] == "HELLO":
                ...
                if message[1] in tcpThreads:
                    ...
                    print(
                        f"{Fore.LIGHTYELLOW_EX}Hello is received from {Fore.RESET}" + f"{Fore.RED}{message[1]}{Fore.RESET}")
                    logging.info(
